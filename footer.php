...
<footer class="bg-dark text-light py-4" style="margin-top: 80px;">
    <div class="container px-4 mt-6">
        <div class="row">
            ...
            <div class="col-12 col-lg-3 text-lg-end">
                ...
                <div>
                    ...
                    <a href="#" class="text-decoration-none text-light"><i class="bi bi-whatsapp fs-2"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-between flex-wrap">
            <p class="mb-0">2025 @ Bhairav Futsal Booking System All Rights Reserved.</p>
            <div>
